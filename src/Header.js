...
export default class Header extends Component {
   ...
   <nav className="navbar navbar-default navbar-static-top m-b-0">
    ...
    <div className="top-left-part"><a className="logo" href="/"><b><img src="../plugins/images/users/1.jpg" alt="logo" /></b><span className="hidden-xs"><strong>Pastor</strong>Patrick</span></a></div>
